export default {
	...
	mj: {
		...
		temperatureInfo:
			"(temperature) değeri arttıkça yanıtlar daha rastlantısal hale gelir",
		top_p: "Üst Olasılık Örnekleme",
		top_pInfo:
			"(top_p) rastlantısallığa benzer ancak sıcaklık ile birlikte değiştirilmemelidir",
		presence_penalty: "Konu Tazeliği",
		presence_penaltyInfo:
			"(presence_penalty) değeri arttıkça, yeni konulara genişleme olasılığı daha yüksektir",
		frequency_penalty: "Frekans Cezası",
		frequency_penaltyInfo:
			"(frequency_penalty) değeri arttıkça, tekrarlanan kelimelerin azaltılma olasılığı daha yüksektir",
		...
		micRec:
			"Kayıt başlat, lütfen konuşun! 2 saniye boyunca ses yoksa otomatik olarak duracaktır.",
		...
		klingInfo:
			"Açıklama: <li>1. Yüksek kalite fiyatın 3.5 katıdır</li> <li>2. 10 saniye fiyatın 2 katıdır</li> <li>3. Son kare etkili olması için bir referans resmine sahip olmalıdır</li>",
		...
		rtsetting:
			"Lütfen sunucuyu ayarlayın. Şu anda Realtime yalnızca uzaktan hizmetleri desteklemektedir; yerel hizmetler için lütfen yazarla iletişime geçin.",
		...
		rtservererror2:
			"Kaydetme desteklenmiyor, bu cihaz kaynaklı bir sorun olabilir!",
		...
		ud_v130: "Uzun Süreli",
		ud_info:
			"Not: <ul><li>1. Udio-32 kısa süreye sahiptir</li><li>2. Udio-130, Udio-32'nin iki katı fiyatındadır</li><li>3. İpucu, tarz, açıklama vb. içerebilir</li></ul>",
		...
		upImg2:
			'<span><b>Görüntü Yükle</b><br/>Bu model görüntü tanımayı desteklemektedir<br>Not: Ekstra görüntü ücretleri olacaktır<br/>Formatlar: jpeg jpg png gif</span><p>Sürükleyip bırakmayı destekler</p> <p class="pt-2"><b>MP3 MP4 Yükle</b> <br>otomatik olarak whisper-1 modelini çağıracaktır<br>Formatlar: mp3 mp4 mpeg mpga m4a wav webm</p>',
		rml_info:
			"Not:<ul><li>1. Bir resim içermelidir</li><li>2. Modelin yalnızca bir gen3a_turbo'su vardır</li><li>3. 10 saniyenin fiyatı 5 saniyenin iki katıdır</li></ul>",
		rml_heng: "Yatay",
		rml_shu: "Dikey",
	},
	mjset: {
	...
	mjchat: {
		...
		addPlaceholder:
			"GPT'lerin GID'sini buraya yapıştırın veya GPT'lerin bağlantısını doğrudan yapıştırın",
	...
	video: {
		...
		repeat: "Yeniden dene",
		lumainfo:
			"Açıklama: <ul><li>1. Pro ve rahat demo videoları su işareti olan bağlantılara sahiptir.</li><li>2. Pro su işaretsiz sürüm, 'İndir' düğmesi aracılığıyla indirme bağlantısını almayı gerektirir.</li><li>3. Pro sürümler için bağlantılar zaman sınırlıdır; lütfen MP4 dosyasını yerel olarak zamanında kaydedin.</li><li>4. Pro sürümler için, 30 dakika içinde MP4 dosyasını yerel olarak kaydedin, çünkü kanal engellenebilir veya durdurulabilir.</li><li>5. Pro sürümleri için indirme bağlantısı geçersizse, su işareti olan video bağlantısı sağlanacaktır.</li></ul>",
		runwayabout: "Runway ile İlgili",
		runwayserver: "Runway API Adresi",
		setOpenKeyPlaceholder2: "Runway API anahtarı, isteğe bağlı",
		endImg: "Son kare",
		runwayinfo:
			"Açıklama: <ul><li>1. Runway görüntüleri ve videoları geçerlilik süresine sahiptir.</li><li>2. Lütfen video oluşturduktan sonra 30 dakika içinde MP4 dosyasını yerel olarak kaydedin.</li></ul>",
