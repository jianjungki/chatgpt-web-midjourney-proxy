	...
	<div class="p-1">
        ...
        <template #prefix>
			...
			<n-input
				...
				:placeholder="$t('mj.ud_prompt_pls')"
				type="textarea"
				size="small"
		...
		<div class="pt-4">
			<n-radio-group
				v-model:value="f.lyrics_type"
				name="radiobuttongroup1"
				size="small"
			>
				<n-radio-button
					v-for="song in lyriceConfig"
					:key="song.key"
					:value="song.key"
					:label="song.value"
				>
...
@click="f.continue_clip_id = ''"
							>清除</span
						></NTag
					>
				</div>
				<n-slider
v-model:value="f.continue_at"
:step="0.01"
:max="1">
					<template #thumb>
						<div
...
preview-disabled>
					...
					<div class="flex-1 pl-2">
						...
						<div
							v-if="exSuno.lyrics || exSuno.prompt"
		...
		<div
class="pt-4 px-2 text-[12px]"
v-text="t('mj.ud_info')"></div>
	</div>
</template>
