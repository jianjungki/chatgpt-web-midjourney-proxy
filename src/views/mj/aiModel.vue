...
:max="50" />
	...
	<section class="flex justify-between items-center">
		...
		<div class="flex justify-end items-center w-[80%] max-w-[240px]">
			<div class="w-[200px]">
				<n-slider
					v-model:value="nGptStore.max_tokens"
					:step="1"
					:max="config.maxToken"
					:min="1"
				/>
	...
	<template v-if="st.openMore">
		<section class="flex justify-between items-center">
			...
			<div class="flex justify-end items-center w-[80%] max-w-[240px]">
				<div class="w-[200px]">
					<n-slider
						v-model:value="nGptStore.temperature"
						:step="0.01"
						:max="1"
					/>
				</div>
...
:max="1" />
		...
		<section class="flex justify-between items-center">
			...
			<div class="flex justify-end items-center w-[80%] max-w-[240px]">
				<div class="w-[200px]">
					<n-slider
						v-model:value="nGptStore.presence_penalty"
						:step="0.01"
						:max="1"
					/>
				</div>
		...
		<section class="flex justify-between items-center">
			...
			<div class="flex justify-end items-center w-[80%] max-w-[240px]">
				<div class="w-[200px]">
					<n-slider
						v-model:value="nGptStore.frequency_penalty"
						:step="0.01"
						:max="1"
					/>
				</div>
		...
		<section class="mb-4 flex justify-between items-center">
			...
			<n-select
				v-model:value="nGptStore.tts_voice"
				:options="voiceList"
				size="small"
				class="!w-[50%]"
			/>
	...
	<div
		v-else
		class="text-right cursor-pointer mb-4"
		@click="st.openMore = true"
	>
		<NTag
			type="primary"
			round
