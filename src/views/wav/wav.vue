...
<template>
  ...
  <div class="p-4">
    ...
    <div class="space-x-2">
      <NButton v-if="!st.isConnect" type="primary" @click="go">
        连接
      </NButton>
      <NButton v-else type="primary" @click="disconnectConversation">
        断开
      </NButton>
      <NButton type="primary" @click="homeStore.setMyData({ act: 'openRealtime' })">
        开始
      </NButton>
    </div>
