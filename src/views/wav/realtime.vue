...
style="--vh: 80px; --vw: 400px">
			<div class="absolute top-0 left-0">
				<canvas
					ref="clientCanvasRef"
					class="h-[var(--vh)] w-[var(--vw)]"
					style="transform: rotate(90deg); transform-origin: 0 var(--vh)"
				/>
			</div>
			<div class="absolute top-0 right-0">
				<canvas
					...
					style="
						...
						transform-origin: var(--vw) var(--vh);
					"
				/>
			</div>
...
@click="st.showSetting = true"
				...
				<section>
					<div class="flex justify-center items-center space-x-4">
						<div
							...
							@click="((st.showSetting = true), disconnectConversation())"
						>
							<div class="bg-white rounded-full p-2">
								<SvgIcon
									icon="ri:settings-3-line"
									class="text-3xl text-orange-500/75"
								></SvgIcon>
							</div>
	...
	<NModal
		v-model:show="st.showSetting"
		title="RealTime Setting"
		preset="card"
