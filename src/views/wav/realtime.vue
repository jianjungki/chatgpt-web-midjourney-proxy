...
const myListen = () => {
  ...
  if (gptServerStore.myData.TTS_VOICE && ['alloy', 'shimmer', 'echo'].includes(gptServerStore.myData.TTS_VOICE)) {
      ...
      <div class="flex flex-col justify-around items-center w-full h-full">
        <section>
          ...
          <div v-if="!st.apikey || !st.baseUrl">
            <div class="p-5 text-center" v-html="$t('mj.rtsetting')" />
          ...
          <div class="flex justify-center items-center space-x-4">
            <div class="flex flex-col justify-center items-center cursor-pointer" @click="st.showSetting = true, disconnectConversation() ">
              <div class=" bg-white rounded-full p-2">
                <SvgIcon icon="ri:settings-3-line" class="text-3xl text-orange-500/75" />
              </div>
              <div class="pt-1">
                {{ $t('setting.setting') }}
              </div>
            ...
            <div class="flex flex-col justify-center items-center cursor-pointer" @click="close()">
              ...
              <div class="bg-red-500 rounded-full p-2">
                <SvgIcon icon="majesticons:phone-hangup" class="text-3xl text-white" />
              </div>
              <div class="pt-1">
                {{ $t('mj.mCanel') }}
              </div>
            ...
            <div v-if="st.isConnect" class="flex flex-col justify-center items-center cursor-pointer" @click="disconnectConversation()">
              <div class=" bg-white rounded-full p-2">
                <SvgIcon icon="ri:wechat-line" class="text-3xl text-orange-500/75" />
              </div>
              <div class="pt-1">
                {{ $t('mj.mPause') }}
              </div>
